...
include("db2.php");
	...
	if(empty($sim_card_number) || empty($MB_max)) {	
		...
		$result = mysqli_query($mysqli, "UPDATE `ProCat_ID` SET `sim_card_number`='$sim_card_number',`MB_max`='$MB_max' WHERE `Serial_Number` LIKE '0411180A3E26000008'");
...
$result = mysqli_query($mysqli, "SELECT * FROM `ProCat_ID` WHERE `Serial_Number` LIKE '0411180A3E26000008'");
...
<body>
  ...
  <form action="edit24.php" method="post" name="form1">
