...
include("db2.php");
	...
	$Imax = mysqli_real_escape_string($mysqli, $_POST['Imax']);
	...
	if(empty($Imax)) {	
		...
		//updating the table
		$result = mysqli_query($mysqli, "UPDATE UPR_Alerts SET Imax='$Imax'");
...
$result = mysqli_query($mysqli, "SELECT Imax FROM UPR_Alerts");
...
<body>
	...
	<div class="container">
  <h2>Editar Alerta</h2>
  <form action="edit7.php" method="post" name="form1">
    <div class="form-group">
      <label for="Imax">Imax:</label>
      <input type="text" class="form-control" name="Imax" value="<?php echo $row['Imax']; ?>">
    </div>
