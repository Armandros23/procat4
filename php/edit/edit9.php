...
include("db2.php");
	...
	$GPS = mysqli_real_escape_string($mysqli, $_POST['GPS']);
	...
	if(empty($GPS)) {	
		...
		//updating the table
		$result = mysqli_query($mysqli, "UPDATE UPR_Alerts SET GPS='$GPS'");
...
$result = mysqli_query($mysqli, "SELECT GPS FROM UPR_Alerts");
...
<body>
	...
	<div class="container">
  <h2>Editar Alerta</h2>
  <form action="edit9.php" method="post" name="form1">
