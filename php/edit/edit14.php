...
include("db2.php");
	...
	$Name_2 = mysqli_real_escape_string($mysqli, $_POST['Name_2']);
	$Cellphone_2 = mysqli_real_escape_string($mysqli, $_POST['Cellphone_2']);	
	
	// checking empty fields
	if(empty($Name_2) || empty($Cellphone_2)) {	
		...
		//updating the table
		$result = mysqli_query($mysqli, "UPDATE ProCat_Alerts SET Name_2='$Name_2', Cellphone_2='$Cellphone_2', Command=1 WHERE Input=1");
		$result = mysqli_query($mysqli, "UPDATE ProCat_Alerts SET Name_2='$Name_2', Cellphone_2='$Cellphone_2', Command=1 WHERE Input=2");
...
<body>
  ...
  <form action="edit14.php" method="post" name="form1">
	<div class="form-group">
      <label for="Name_2">Nome:</label>
      <input type="text" class="form-control" name="Name_2" value="<?php echo $row['Name_2']; ?>">
    </div>
	<div class="form-group">
      <label for="Cellphone_2">Telefone:</label>
      <input type="text" class="form-control" name="Cellphone_2" value="<?php echo $row['Cellphone_2']; ?>">
    </div>
