...
include("db2.php");
	...
	$Fuse_Vout_Pos = mysqli_real_escape_string($mysqli, $_POST['Fuse_Vout_Pos']);
	
	// checking empty fields
	if(empty($Fuse_Vout_Pos)) {	
		...
		//updating the table
		$result = mysqli_query($mysqli, "UPDATE UPR_Alerts SET Fuse_Vout_Pos='$Fuse_Vout_Pos'");
...
$result = mysqli_query($mysqli, "SELECT Fuse_Vout_Pos FROM UPR_Alerts");
...
<body>
	...
	<div class="container">
  <h2>Editar Alerta</h2>
  <form action="edit2.php" method="post" name="form1">
    <div class="form-group">
      <label for="Fuse_Vout_Pos">Alerta Fusivel V+:</label>
      <input type="text" class="form-control" name="Fuse_Vout_Pos" value="<?php echo $row['Fuse_Vout_Pos']; ?>">
    </div>
