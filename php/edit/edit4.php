...
include("db2.php");
	...
	$Fuse_Uref = mysqli_real_escape_string($mysqli, $_POST['Fuse_Uref']);
	...
	if(empty($Fuse_Uref)) {	
		...
		//updating the table
		$result = mysqli_query($mysqli, "UPDATE UPR_Alerts SET Fuse_Uref='$Fuse_Uref'");
...
$result = mysqli_query($mysqli, "SELECT Fuse_Uref FROM UPR_Alerts");
...
<body>
	...
	<div class="container">
  <h2>Editar Alerta</h2>
  <form action="edit4.php" method="post" name="form1">
    <div class="form-group">
      <label for="Fuse_Uref">Alerta Fusivel Uref:</label>
      <input type="text" class="form-control" name="Fuse_Uref" value="<?php echo $row['Fuse_Uref']; ?>">
    </div>
