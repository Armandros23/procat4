...
include("db2.php");
	...
	$TR = mysqli_real_escape_string($mysqli, $_POST['TR']);
	...
	if(empty($TR)) {	
		...
		//updating the table
		$result = mysqli_query($mysqli, "UPDATE UPR_Alerts SET TR='$TR'");
...
$result = mysqli_query($mysqli, "SELECT TR FROM UPR_Alerts");
...
<body>
	...
	<div class="container">
  <h2>Editar Alerta</h2>
  <form action="edit5.php" method="post" name="form1">
    <div class="form-group">
      <label for="TR">TR:</label>
      <input type="text" class="form-control" name="TR" value="<?php echo $row['TR']; ?>">
    </div>
