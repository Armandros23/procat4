...
include("db2.php");
	...
	$Umax = mysqli_real_escape_string($mysqli, $_POST['Umax']);
	...
	if(empty($Umax)) {	
		...
		//updating the table
		$result = mysqli_query($mysqli, "UPDATE UPR_Alerts SET Umax='$Umax'");
...
$result = mysqli_query($mysqli, "SELECT Umax FROM UPR_Alerts");
...
<body>
	...
	<div class="container">
  <h2>Editar Alerta</h2>
  <form action="edit6.php" method="post" name="form1">
    <div class="form-group">
      <label for="Umax">Umax:</label>
      <input type="text" class="form-control" name="Umax" value="<?php echo $row['Umax']; ?>">
    </div>
