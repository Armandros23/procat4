...
if(isset($_POST['Submit'])) {
	...
	if( empty($Nome) || empty($Mail) ) {
		...
		if(empty($Nome)) {
			echo "<br/><div class=\"container\"><div class=\"alert alert-danger\"><strong>Alerta!</strong> Este campo não pode ficar em branco. Insira o nome do novo utilizador.</div></div><br/>";

		}

		if(empty($Mail)) {
			echo "<br/><div class=\"container\"><div class=\"alert alert-danger\"><strong>Alerta!</strong> Este campo não pode ficar em branco. Insira o E-Mail do utilizador da plataforma.</div></div><br/>";
		}
		...
		$result = mysqli_query($mysqli, "INSERT INTO ProCat_Mails(Nome,Mail) VALUES('$Nome','$Mail')");
